...
{
	case '1':
		$base_url     = $session->get('FilesBaseUrl');
		$upload_dir   = $session->get('FilesImagesUrl') ? $session->get('FilesImagesUrl') : 'images/';
		$current_path = $session->get('FilesImagesUrl') ? $session->get('FilesImagesPath') : '../../../../../images/';
		break;

	case '2':
		$base_url     = $session->get('FilesBaseUrl');
		$upload_dir   = $session->get('FilesFilesUrl') ? $session->get('FilesFilesUrl') : 'upload/';
		$current_path = $session->get('FilesFilesUrl') ? $session->get('FilesFilesPath') : '../../../../../upload/';
		break;
}
...
$config = [
	...
	'thumbs_base_path'                 => $session->get('FilesThumbsPath') ? $session->get('FilesThumbsPath') : 'cache/_thumbs',
	'thumbs_upload_dir'                => $session->get('FilesThumbsPath') ? $session->get('FilesThumbsPath') : 'cache/_thumbs',
	...
	*/
	...
	|
	*/
	'MaxSizeUpload'                  => $session->get('FilesMaxImagesSize') ? $session->get('FilesMaxImagesSize') : 10,
	...
	*/
	'filePermission'                 => 0755,
	'folderPermission'               => $session->get('FilesSettingsChmod'),
	...
	|--------------------------------------------------------------------------
	*/
	'default_language'               => $session->get('FilesLang'),
	...
	*/
	...
	'image_max_width'                => $session->get('FilesMaxImageWidth') ? $session->get('FilesMaxImageWidth') : 1600,
	'image_max_height'               => $session->get('FilesMaxImageHeight') ? $session->get('FilesMaxImageHeight') : 1200,
	'image_max_mode'                 => 'auto',
	/*
	...
	*/
	...
	'image_resizing'                 => true,
	'image_resizing_width'           => $session->get('FilesMaxImageWidth') ? $session->get('FilesMaxImageWidth') : 1600,
	'image_resizing_height'          => $session->get('FilesMaxImageHeight') ? $session->get('FilesMaxImageHeight') : 1200,
