...
(function() {
	 ...
	 *
	 * Controls can be added in {@link #display} method using {@link CKEDITOR.plugins.aychecker.ViwerForm}
	 * methods.
	 *
	 * ### Executing the fix
	 *
	...
	QuickFix.prototype = {
		/**
		 * @member CKEDITOR.plugins.aychecker.quickFix.QuickFix
		 * @property {CKEDITOR.plugins.aychecker.Issue} issue Issue object that QuickFix was created for.
		 */
		issue: null
	};
	...
	QuickFix.prototype.lang = {};
			CKEDITOR.plugins.aychecker.quickFixes.add( 'en/QuickFix', QuickFix );
}());
