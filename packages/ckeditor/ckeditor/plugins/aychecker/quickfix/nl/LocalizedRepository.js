...
define( [ 'quickfix/Repository' ], function( Repository ) {
	...
	/**
	 * See {@link CKEDITOR.plugins.aychecker.quickFix.Repository#get}. This implementation
	 * adds only `options.langCode` param:
	 *
	 * @member CKEDITOR.plugins.aychecker.quickFix.LocalizedRepository
	...
	LocalizedRepository.prototype.get = function( options ) {
		...
		if ( !CKEDITOR.plugins.aychecker.dev ) {
	...
	LocalizedRepository.prototype.deferGetCall = function( langCode, getArguments ) {
		...
		if ( !CKEDITOR.plugins.aychecker.dev || this._langDictionary[ langCode ] ) {
